...
public class MantenimientosController {
    ...
    private ResponseEntity<Page<MantenimientosDTO>> datosMantenimientos(
        ...
        Page<MantenimientosDTO> mantenimientos = acceso.getAllMantenimientos(page, size);
        if (mantenimientos == null){
            ResponseEntity.badRequest().body(Map.of(
                    "status", "No hay mantenimientos registrados"
            ));
        }
