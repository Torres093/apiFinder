...
public class DetallesReservaService {
    ...
    public List<DetallesReservaDTO> getAllDetallesReserva() {
        List<DetallesReservaEntity> detallesReserva = repo.findAll();
        return detallesReserva.stream()
                .map(this::convertirADetalleReservaDTO)
